...
INSERT INTO producto (id_producto, nombre_producto, descripcion_producto, precio_producto, id_categoria)
...
INSERT INTO factura (id_cliente, fecha_factura, subtotal,iva, precio_total)
...
INSERT INTO detalle_factura(id_factura,id_producto,cantidad_producto)
VALUES (1,'A001P001',1);
INSERT INTO detalle_factura(id_factura,id_producto,cantidad_producto)
VALUES (1,'A001P002',1);
...
SELECT nombre_cliente, precio_total FROM factura INNER JOIN cliente ON factura.id_cliente = cliente.id_cliente  WHERE precio_total=(SELECT max(precio_total) FROM factura);
...
SELECT nombre_cliente, precio_total FROM factura INNER JOIN cliente ON factura.id_cliente = cliente.id_cliente  WHERE precio_total > 10;
...
SELECT COUNT (DISTINCT id_cliente) FROM (SELECT id_producto, id_cliente FROM detalle_factura INNER JOIN factura ON detalle_factura.id_producto = 'F002P003') AS n;
